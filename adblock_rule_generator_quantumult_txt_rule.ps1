# Title: AdBlock_Rule_For_Quantumult_RULE
# Description: 适用于Quantumult的域名拦截txt格式RULE规则，每20分钟更新一次，确保即时同步上游减少误杀
...
$textContent = @"
# Title: AdBlock_Rule_For_Quantumult_RULE
# Description: 适用于Quantumult的域名拦截文本格式RULE规则，每20分钟更新一次，确保即时同步上游减少误杀
# Homepage: https://github.com/REIJI007/AdBlock_Rule_For_Quantumult
...
# 定义输出文件路径
$outputPath = "$PSScriptRoot/adblock_reject_quantumult_rule.txt"
